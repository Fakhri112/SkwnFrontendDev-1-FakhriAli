		...
		<section className="md:grid md:grid-cols-12 flex flex-col items-center">
			<div className="col-span-8 grid place-items-center ">
				<div className="text-center md:text-start mt-20">
					...
					<div className="flex md:flex-row flex-col gap-2 mt-6 items-center justify-center">
						<button className="bg-secondary md:py-5 md:px-6 p-5 rounded-lg w-[70%] md:w-full flex gap-4 items-center">
							<Magnifier />
							<p>SEARCH CATALOG</p>
						</button>
						<button className="md:py-5 md:px-6 p-5 rounded-lg border flex w-[70%] md:w-full  gap-4 items-center">
							<Play />
							<p>WATCH VIDEOS</p>
						</button>
					</div>
			...
			<div className="md:col-span-4 relative flex justify-end md:mt-0 mt-16 md:w-auto w-full md:h-auto h-72">
				...
				<div className="absolute bottom-10 left-18 p-2">
